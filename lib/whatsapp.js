...
class WhatsAppClient {
  ...
  _findChrome() {
    ...
    // If no Chrome found, return undefined to let Puppeteer use its bundled Chromium
    logger.log('⚠️ Chrome not found, using Puppeteer bundled Chromium (will download if needed)');
    return undefined;
  }
